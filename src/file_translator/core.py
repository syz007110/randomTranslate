...
# Default terminology DB path - can be overridden via TRANSLATOR_DB_PATH env var
DEFAULT_DB_PATH = Path(__file__).parent / "translator_terms.db"
DB_PATH = Path(os.getenv("TRANSLATOR_DB_PATH", str(DEFAULT_DB_PATH)))
